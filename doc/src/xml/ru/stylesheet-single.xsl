...
<!-- <xsl:import href="http://docbook.sourceforge.net/release/xsl/current/xhtml/profile-onechunk.xsl"/> -->
<!-- ^^^ Invalid xsl (see https://sourceforge.net/p/docbook/bugs/1335/) -->
<xsl:include href="profile-onechunk.xsl" />
