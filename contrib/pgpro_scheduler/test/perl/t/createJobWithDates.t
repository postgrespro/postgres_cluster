...
$query = "SELECT schedule.create_job(ARRAY[(now() + interval \'1 minute\')::timestamp with time zone,
            ...
            ARRAY[\'INSERT INTO test_results (time_mark, commentary) VALUES(now(), ''createJobWithDates'')\',
                    \'INSERT INTO test_results (time_mark, commentary) VALUES(now(), ''createJobWithDates'')\']);";
